package com.rishbootdev.employeemanagementsystem.repository;

import com.rishbootdev.employeemanagementsystem.dto.EmployeeSummary;
import com.rishbootdev.employeemanagementsystem.entity.Employee;
import com.rishbootdev.employeemanagementsystem.projection.EmployeeView;
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("SELECT new com.rishbootdev.employeemanagementsystem.dto.EmployeeSummary(e.id, e.name, e.email, d.name) FROM Employee e LEFT JOIN e.department d")
